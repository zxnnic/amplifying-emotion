...
neutral_path = r"nicole_neutral_long.csv"
...
amplified_AMP = amplify(mean, neutral, mode="amp", control_dict={0:0, 20:3, 60:0, 100:4})
amplified_LIN = amplify(mean, neutral, mode="lin", control_dict={0:0, 20:3, 60:0, 100:4})
